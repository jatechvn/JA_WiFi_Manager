...
class _MainWindowState extends State<MainWindow>
  ...
  // ─── MONITOR TAB (Dashboard view) ──────────────────────────────────────────

  Widget _buildMonitorTab() {
    final clients = widget.logic.connectedClients;
    final filtered = widget.logic.filteredConnectedClients;
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return _buildClientRow(client, index);
                          },
                        ),
                      ),
                    ],
  ...
  Widget _buildClientRow(ClientDevice client, int index) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(
            bottom:
                BorderSide(color: _c.borderDefault.withValues(alpha: 0.08))),
      ),
        ...
        children: [
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    ...
                    _showSnackbar('MAC copied: ${client.mac}');
                  },
                  child: Text(
                    client.mac,
                    style: TextStyle(
          ...
          Expanded(
            ...
            child: Text(
              ...
              style: TextStyle(
                color:
                    client.nickname.isNotEmpty ? _c.textPrimary : _c.textMuted,
                fontSize: 13,
