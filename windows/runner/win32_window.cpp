...
static bool IsWindows11OrGreater() {
  ...
  if (hMod) {
    typedef LONG(WINAPI* pfnRtlGetVersion)(POSVERSIONINFOW);
...
void Win32Window::UpdateTheme(HWND const window, bool is_startup) {
  DWORD light_mode = 1;
  ...
  if (IsWindows11OrGreater()) {
    ApplyThemeWin11(window, is_dark, is_startup);
  } else {
